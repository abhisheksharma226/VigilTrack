...
const mockSightings = [
  {
    ...
    status: 'verified',
    matchedWith: 'CASE-2024-001',
    reporter: 'Public Submission',
  },
  {
    id: 2,
    location: 'Transit Station, Seattle WA',
  ...
  {
    id: 3,
    location: 'Shopping Mall, Eugene OR',
    dateReported: '2024-02-01',
    status: 'verified',
    matchedWith: 'CASE-2024-003',
    reporter: 'Public Submission',
  },
]
...
export default function AdminPage() {
  ...
  const filteredMissingPersons = mockMissingPersons.filter(person =>
        ...
        <section className="bg-white border-b border-border">
          <div className="mx-auto max-w-7xl px-6 py-8">
            ...
            <p className="text-muted-foreground mt-2">
              Manage missing person cases and sighting reports
            </p>
          </div>
        </section>
                            ...
                            <div className="flex items-center gap-2">
                              <div className="h-2 w-16 bg-secondary rounded-full overflow-hidden">
                                <div
                                  ...
                                  style={{ width: `${person.matchProbability}%` }}
                                />
                              </div>
                    ...
                    <tbody>
                      {filteredSightings.map((sighting) => (
                        <tr key={sighting.id} className="border-b border-border hover:bg-secondary transition-colors">
                          ...
                          <td className="py-3 px-4">
                            {sighting.matchedWith ? (
                              <p className="text-sm font-medium text-primary">{sighting.matchedWith}</p>
                            ) : (
